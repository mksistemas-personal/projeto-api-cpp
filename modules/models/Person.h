...
class Person
{
  public:
    struct Cols
    {
        ...
        static const std::string _document;
    ...
    /**  For column document  */
    ///Get the value of the column document, returns the default value if the column is null
    const std::string &getValueOfDocument() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getDocument() const noexcept;
    ///Set the value of the column document
    void setDocument(const std::string &pDocument) noexcept;
    void setDocument(std::string &&pDocument) noexcept;
  ...
  private:
    ...
    friend drogon::orm::BaseBuilder<Person, true, true>;
    friend drogon::orm::BaseBuilder<Person, true, false>;
    friend drogon::orm::BaseBuilder<Person, false, true>;
    friend drogon::orm::BaseBuilder<Person, false, false>;
#ifdef __cpp_impl_coroutine
    ...
    std::shared_ptr<std::string> document_;
